...
public class NetworkModule {
    ...
    @Provides
    @Singleton
    WebSocketClient provideWsClient(OkHttpClient client, ServerRepository servers, com.qns.utils.NotificationHelper notifications) {
        return new WebSocketClient(client, servers, notifications);
    }
}
